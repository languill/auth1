...
if($_SERVER['REQUEST_METHOD'] == 'POST') {	
	...
	if(!empty($user)) {	
		set_flash_message("danger", "Этот @-адрес уже занят другим пользователем");
		redirect_to("/create_user.php");
	} else {
		// загрузка файл
		$avatar = upload_file($_FILES['avatar']['name'], $_FILES['avatar']['tmp_name']);
		/*
		$avatar = setUniqueFileName($_FILES['avatar']['name']);	
		...
		*/
		...
		add_user_by_admin($email, $password, $user_name, $job_title, $phone, $address, $status, $avatar, $vk, $telegram, $instagram);
		set_flash_message("success", "Новый пользователь зарегестрирован");
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
		...
		<div class="col-xl-6"><?php display_flash_message("danger");?></div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user_name" type="text" id="simpleinput" class="form-control">
                                </div>
