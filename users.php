...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
			...
			<?php display_flash_message("warning");?>
            ...
            <div class="row">
                <div class="col-xl-12">
					<?php if ($logined_user['role'] == 'admin') : ?>
                    <a class="btn btn-success" href="create_user.php">Добавить</a>
					<?php endif; ?>
					
					<div class="mt-3"><?php display_flash_message("success");?></div>	
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4"> <!-- начало -->
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php has_image($user['id']); ?>'); background-size: cover;"></span>									
                                </span>
								
                                <div class="info-card-text flex-1">
									<a href="page_profile.php?id=<?php echo $user['id']; ?>" class="fs-xl text-truncate text-truncate-lg text-info"><?php echo $user['user_name']; ?></a>
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
									<?php if ($logined_user['role'] == 'admin' || $logined_user['id'] == $user['id']) : ?>
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                    </a>
																	
                                    <div class="dropdown-menu"> <!-- редакт. начало -->
