...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$email = text_validate($_POST['email']);
	$password = text_validate($_POST['password']);
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="security.php?id=<?php echo $user['id']?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="text" id="simpleinput" class="form-control" value="<?php echo $user['email'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="retype_password" type="password" id="simpleinput" class="form-control">
                                </div>
